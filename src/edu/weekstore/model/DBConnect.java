...
public interface DBConnect {
    ...
    final static String PRODUCT_SELECT_BEST = "SELECT p.imgsrc1 FROM product p JOIN serve s ON p.pno = s.pno GROUP BY p.pno, p.imgsrc1 ORDER BY SUM(s.amount) DESC LIMIT 1";
